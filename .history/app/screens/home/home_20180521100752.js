      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.container1}>
            <TouchableOpacity
                onPress={() => this.props.navigation.navigate('ProductList', {Table})}>
            ...
            <TouchableOpacity
                onPress={() => this.props.navigation.navigate('ProductList', {Sofas})}>
                <View style={styles.touchable}>
          ...
          <View style={styles.container1}> */}
            <TouchableOpacity
                onPress={() => this.props.navigation.navigate('ProductList', {Chairs})}>
                <View style={styles.touchable}>
            ...
            <Text style={{width: 13}} ></Text>
            <TouchableOpacity
                onPress={() => this.props.navigation.navigate('ProductList', {Cupboards})}>
                <View style={styles.touchable}>
